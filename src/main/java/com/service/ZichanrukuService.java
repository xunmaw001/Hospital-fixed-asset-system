...
public interface ZichanrukuService extends IService<ZichanrukuEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<ZichanrukuEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<ZichanrukuEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<ZichanrukuEntity> wrapper);
}
