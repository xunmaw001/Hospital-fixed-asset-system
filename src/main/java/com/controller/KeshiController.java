...
public class KeshiController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		KeshiEntity user = keshiService.selectOne(new EntityWrapper<KeshiEntity>().eq("keshihao", username));
		if(user==null || !user.getMima().equals(password)) {
			return R.error("账号或密码不正确");
		}
		
		String token = tokenService.generateToken(user.getId(), username,"keshi",  "科室" );
    ...
    public R register(@RequestBody KeshiEntity keshi){
    	//ValidatorUtils.validateEntity(keshi);
    	KeshiEntity user = keshiService.selectOne(new EntityWrapper<KeshiEntity>().eq("keshihao", keshi.getKeshihao()));
		if(user!=null) {
    ...
    public R getCurrUser(HttpServletRequest request){
        ...
        KeshiEntity user = keshiService.selectById(id);
