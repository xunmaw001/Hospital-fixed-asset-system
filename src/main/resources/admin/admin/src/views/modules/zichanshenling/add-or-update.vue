  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shenlingshijian" label="申领时间" prop="shenlingshijian">
              <el-input v-model="ruleForm.shenlingshijian" 
                placeholder="申领时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="申领说明" prop="shenlingshuoming">
          <el-input v-model="ruleForm.shenlingshuoming" 
              placeholder="申领说明" clearable  :readonly="ro.shenlingshuoming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="申领说明" prop="shenlingshuoming">
              <el-input v-model="ruleForm.shenlingshuoming" 
                placeholder="申领说明" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
