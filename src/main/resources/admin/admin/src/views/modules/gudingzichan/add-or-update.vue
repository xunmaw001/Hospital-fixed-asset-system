  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zichanbianma" label="资产编码" prop="zichanbianma">
              <el-input v-model="ruleForm.zichanbianma" 
                placeholder="资产编码" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="资产详情" prop="zichanxiangqing">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.zichanxiangqing" label="资产详情" prop="zichanxiangqing">
                    <span v-html="ruleForm.zichanxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="归属说明" prop="guishushuoming">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.guishushuoming" label="归属说明" prop="guishushuoming">
                    <span v-html="ruleForm.guishushuoming"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="使用描述" prop="shiyongmiaoshu">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shiyongmiaoshu" label="使用描述" prop="shiyongmiaoshu">
                    <span v-html="ruleForm.shiyongmiaoshu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.zichanxiangqing = this.ruleForm.zichanxiangqing.replace(reg,'../../../springbootd9y56/upload');
	this.ruleForm.guishushuoming = this.ruleForm.guishushuoming.replace(reg,'../../../springbootd9y56/upload');
	this.ruleForm.shiyongmiaoshu = this.ruleForm.shiyongmiaoshu.replace(reg,'../../../springbootd9y56/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
