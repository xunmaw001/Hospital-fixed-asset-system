    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="资产说明" prop="zichanshuoming">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.zichanshuoming" label="资产说明" prop="zichanshuoming">
                    <span v-html="ruleForm.zichanshuoming"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="申购原因" prop="shengouyuanyin">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.shengouyuanyin" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shengouyuanyin" label="申购原因" prop="shengouyuanyin">
                    <span v-html="ruleForm.shengouyuanyin"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zichanshuoming = true;
          ...
          if(o=='shengouyuanyin'){
            this.ruleForm.shengouyuanyin = obj[o];
	    this.ro.shengouyuanyin = true;
            continue;
          }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.keshihao!=''&&json.keshihao){
                this.ruleForm.keshihao = json.keshihao
	    		this.ro.keshihao = true;
		}
	...
	this.ruleForm.zichanshuoming = this.ruleForm.zichanshuoming.replace(reg,'../../../springbootd9y56/upload');
	this.ruleForm.shengouyuanyin = this.ruleForm.shengouyuanyin.replace(reg,'../../../springbootd9y56/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
